...
const shell = require('gulp-shell');  // 引入 gulp-shell 插件
const through2 = require('through2');  // 引入 through2 插件
const { exec } = require('child_process');  // 使用 Node.js 的 child_process.exec 方法
